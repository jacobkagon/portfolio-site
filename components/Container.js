  ...
  return (
    <div className="bg-white dark:bg-gray-800">
      <Head>
        ...
        <meta property="og:site_name" content="Jacob Kagon" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@jacob_kagon" />
      ...
      <nav className="flex items-center justify-between w-full max-w-4xl p-8 mx-auto my-0 bg-white sticky-nav md:my-8 dark:bg-gray-800 bg-opacity-60">
      ...
      <main
        id="skip"
        className="flex flex-col justify-center px-8 bg-white dark:bg-gray-800"
      >
        {children}
        <Footer />
      </main>
